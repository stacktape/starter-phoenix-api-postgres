...
# Phoenix API with Postgres

> [!TIP]
> To deploy this project using **GUI-based flow**, navigate to [console](https://console.stacktape.com/create-new-project/git-project-using-console?name=my-stacktape-app&repositoryType=public&repositoryUrl=https://github.com/stacktape/starter-phoenix-api-postgres)

- HTTP API built with [Phoenix](https://www.phoenixframework.org/), the Elixir web framework.
- Runs in a Docker [web service](https://docs.stacktape.com/compute-resources/web-services/) with a Postgres
  [relational database](https://docs.stacktape.com/resources/relational-databases/). Uses Ecto for database access.
...
```bash
stacktape init --starterId phoenix-api-postgres
```
